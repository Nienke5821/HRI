...
def scan_world(robot, allobstacles, alltargets):
    ...
    print("sonar_left", sonar_left, "sonar_right", sonar_right, "target_distance", target_distance, "target_angle", target_angle)# print sonar_left, sonar_right, target_distance, target_angle
