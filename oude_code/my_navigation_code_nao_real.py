import math
import numpy as np
import behaviour_based_navigation_challenge3_nao_real as bn
...
def scan_world(robot, allobstacles, alltargets):
    ...
    turn_rate = bn.compute_turnrate(target_distance, target_angle_robot, sonar_left, sonar_right, robot.phi)
